...
* Interactive dashboard for better decision-making

---

## 📊 Dashboard Preview

Refer to: `dashboard_screenshot.png`
...
* Performed data cleaning and analysis using Python and Pandas
* Checked missing values and calculated descriptive statistics
* Created visualizations and insights using Power BI
* Uploaded all project files and documentation to GitHub
